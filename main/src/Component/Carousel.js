            ...
            <div className='card-section1'>
                    ...
                    <div className='container card-elements' >
                        ...
                        <div className='card-element2 '>
                            <div className='card-image'>
                                <img src='/static/images/category_images/headphone.png'></img>
                            </div>
                ...
                <div className='card1 card2'>
                    <div className='container card-elements' >
                        ...
                        <div className='card-element2 '>
                            <div className='card-image'>
                                <img src='/static/images/category_images/cycle.png'></img>
                            </div>
                            <div className='card-content'>
                            ...
                            <div className='card3'>
                                ...
                                <div className='container card3-elements'>
                                    ...
                                    <div className='card3-element2'>
                                        <img src='/static/images/carousel/phone.png'></img>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="carousel-item" data-bs-interval="2000">
                            <div className='card3'>
                                ...
                                <div className='container card3-elements'>
                                    ...
                                    <div className='card3-element2'>
                                        <img src='/static/images/carousel/laptop.png'></img>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="carousel-item">
                            <div className='card3'>
                                ...
                                <div className='container card3-elements'>
                                    ...
                                    <div className='card3-element2'>
                                        <img src='/static/images/carousel/earpods.png'></img>
                                    </div>
                                </div>
                            </div>
                        </div>
