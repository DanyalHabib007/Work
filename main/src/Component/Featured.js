                ...
                <div className='featured-section2-part2'>
                    <div className='featured-section2-part2-part1'>
                        ...
                        <div className='featured-section2-part2-part1-card'>
                            ...
                            <div className='image'><img src='/static/images/category_images/smart-watch.png'></img></div>
                            <div className='title'>Smart Watches</div>
                        </div>
                        </Link>
                        <div className='featured-section2-part2-part1-card'>
                            <div className='price'>$500</div>
                            <div className='image'><img src='/static/images/category_images/camera.png'></img></div>
                            <div className='title'>Cameras</div>
                        </div>
                        <div className='featured-section2-part2-part1-card'>
                            <div className='price'>$20</div>
                            <div className='image'><img src='/static/images/category_images/cooking.png'></img></div>
                    ...
                    <div className='featured-section2-part2-part2'>
                        ...
                        <div className='price'>$20</div>
                            <div className='image'><img src='/static/images/category_images/bedsheet.png'></img></div>
                        ...
                        <div className='featured-section2-part2-part2-card2'>
                            ...
                            <div className='section2'>
                                <img src='/static/images/category_images/washing-machine.png'></img>
                            </div>
                        </div>
                    </div>
                </div>
