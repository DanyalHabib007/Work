                ...
                <div className="row">
                        ...
                        <div className="product-card">
                            <Link  to='/product-view'>
                                <div className="product-card-img">
                                    ...
                                    <img src="/static/images/products/laptop.jpg" alt="Laptop"></img>
                                </div>
                            </Link>
                    ...
                    <div className="col-md-3">
                        <div className="product-card">
                            <div className="product-card-img">
                                <label className="stock bg-success">In Stock</label>
                                <img src="/static/images/products/phone.jpg" alt="Red MI Note 8"></img>
                            </div>
                            <div className="product-card-body">
                    ...
                    <div className="col-md-3">
                        <div className="product-card">
                            <div className="product-card-img">
                                <label className="stock bg-success">In Stock</label>
                                <img src="/static/images/products/shirt.webp" alt="Mens Shirt"></img>
                            </div>
                            <div className="product-card-body">
                    ...
                    <div className="col-md-3">
                        <div className="product-card">
                            <div className="product-card-img">
                                <label className="stock bg-success">In Stock</label>
                                <img src="/static/images/products/headphone.jpg" alt="Head Phone"></img>
                            </div>
                            <div className="product-card-body">
